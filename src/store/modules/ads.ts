...
export class AdsStore extends VuexModule {
  @getter ads: Ad[] = [
    new Ad('1', 1, 'dominicano', new Description('LOPESAN COSTA BAVARO RESORT SPA & CASINO', 'Playas de Bavaro', 'Роскошный отель IFA Villas Bavaro Resort & Spa 4* подарит необычайный комфорт и беззаботность своим гостям, предложив проживание по системе «Все включено».'), [
    ...
    new Ad('2', 2, 'costa-blanca', new Description('LOPESAN COSTA BAVARO RESORT SPA & CASINO', 'Playas de Bavaro', 'Роскошный отель IFA Villas Bavaro Resort & Spa 4* подарит необычайный комфорт и беззаботность своим гостям, предложив проживание по системе «Все включено».'), [
      'https://firebasestorage.googleapis.com/v0/b/udemy-ads.appspot.com/o/ads%2F-LdVEX4BpQUZ_C1NLdr7.jpeg?alt=media&token=6164f01f-893b-4ce3-b977-a4dc03f86d26',
      'https://firebasestorage.googleapis.com/v0/b/udemy-ads.appspot.com/o/ads%2F-LdVyzcND_OCQgKc1Asf.jpeg?alt=media&token=325c930e-6d8c-4758-98c9-57baba4f61f7'
    ], 4, 99),
    new Ad('3', 3, 'mexico', new Description('LOPESAN COSTA BAVARO RESORT SPA & CASINO', 'Playas de Bavaro', 'Роскошный отель IFA Villas Bavaro Resort & Spa 4* подарит необычайный комфорт и беззаботность своим гостям, предложив проживание по системе «Все включено».'), [
